...
export const DashboardPage = () => {
	...
	// Sample tabs data
	const tabs = [
		{ title: "Kanban Board", value: "kanban-board", content: <Kanban /> },
		{ title: "Task List", value: "task-list", content: <TaskList /> },
		{
			title: "Eisenhover Matrix",
		...
		<div className="relative h-full w-full overflow-hidden">
			...
			<div className="h-5/6 w-full flex flex-col items-center p-6 pt-0">
				<div className="w-full h-full bg-white/10 ">
					...
					<Tabs
						tabs={tabs}
						containerClassName="bg-blue-500/50 flex justify-center"
						activeTabClassName="bg-green-500/50"
						tabClassName="bg-yellow-500/50"
						contentClassName="bg-red-500/10"
					/>
				</div>
			</div>
