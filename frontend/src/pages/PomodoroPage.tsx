  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-gray-100 p-6">
      ...
      <div className="mb-4 w-full max-w-md">
        <label className="block text-left mb-2 text-gray-700 font-medium">Focus on Task:</label>
        <select
      ...
      {currentTask && (
        <div className="mt-8 text-lg font-medium text-gray-800">
          🔥 Working on: <span className="font-semibold">{currentTask.description}</span>
        </div>
      )}
    </div>
  );
